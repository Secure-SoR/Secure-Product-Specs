...
**Use when:** [implementation-guide-phase-3-dc.md](../specs/implementation-guide-phase-3-dc.md) Step 3.3 — capture property coordinates for SitDeck / maps / DC Risk Intelligence.  
**Schema:** [schema.md](../database/schema.md) (`properties.latitude`, `properties.longitude` — `numeric`, nullable). **Migration (if needed):** [add-properties-lat-lng.sql](../database/migrations/add-properties-lat-lng.sql)

**Specs copy next to Phase 3 guide:** [../specs/LOVABLE-PROMPT-PROPERTY-LAT-LNG.md](../specs/LOVABLE-PROMPT-PROPERTY-LAT-LNG.md)
...
7. **Do not** create migrations or alter schema from Lovable. If columns are missing, product runs the SQL migration add-properties-lat-lng.sql (backend repo docs/database/migrations/) in Supabase SQL Editor first.
