...
**Filename note:** `LOVABLE-PROMPT-SITDECK-INTEGRATIONS-ACCOUNT-SETTINGS.md` is legacy naming; **entry point is Data Library → Connectors**, not Account Settings → Integrations.

**Duplicate for IDE links:** [../specs/LOVABLE-PROMPT-SITDECK-INTEGRATIONS-ACCOUNT-SETTINGS.md](../specs/LOVABLE-PROMPT-SITDECK-INTEGRATIONS-ACCOUNT-SETTINGS.md) (next to [implementation-guide-phase-3-dc.md](../specs/implementation-guide-phase-3-dc.md)). Keep both files in sync.

**Use when:** [implementation-guide-phase-3-dc.md](../specs/implementation-guide-phase-3-dc.md) Step 3.2 — one SitDeck (OSINT) connector in Data Library → Connectors; token stored securely; widget config per property in `sitdeck_risk_config`.  
