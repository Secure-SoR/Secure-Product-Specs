...
**Use when:** [implementation-guide-phase-3-dc.md](../specs/implementation-guide-phase-3-dc.md) Step 3.7 — show a **PUE** KPI on the main data centre property overview, sourced from **`data_library_records`** (manual, upload, or connector). Not SitDeck DCIM in Phase 3.

**Duplicate for IDE links:** [../specs/LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md](../specs/LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md) — keep both in sync.

**Schema:** [schema.md](../database/schema.md) §3.9 `data_library_records` · DC targets: `dc_metadata.target_pue` (optional comparison) per [secure-dc-spec-v2.md](../specs/secure-dc-spec-v2.md).  
**Optional UX:** dedicated **Site PUE** manual type under Data Library → Energy & Utilities — [LOVABLE-PROMPT-DATA-LIBRARY-SITE-PUE-RECORD.md](LOVABLE-PROMPT-DATA-LIBRARY-SITE-PUE-RECORD.md).

**Target route:** Main DC property overview (e.g. `/dashboards/data-centre/:propertyId`) — same “first screen” as other DC KPIs, not only `/pue` deep-dive.
