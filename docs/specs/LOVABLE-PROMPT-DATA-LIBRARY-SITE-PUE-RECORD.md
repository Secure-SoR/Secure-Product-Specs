...
**Same content as** [../lovable-prompts/LOVABLE-PROMPT-DATA-LIBRARY-SITE-PUE-RECORD.md](../lovable-prompts/LOVABLE-PROMPT-DATA-LIBRARY-SITE-PUE-RECORD.md) — lives here **next to** [implementation-guide-phase-3-dc.md](./implementation-guide-phase-3-dc.md). Keep both in sync.

**Use when:** First-class **Site PUE** manual entry under **Data Library → Energy & Utilities**.  
**Related:** [LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md](./LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md) Step 3.7.
...
- Optional: sync note into [LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md](./LOVABLE-PROMPT-DC-PUE-TILE-DATA-LIBRARY.md).
