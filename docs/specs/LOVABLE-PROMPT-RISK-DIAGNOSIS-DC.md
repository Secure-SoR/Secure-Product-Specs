...
**Filename:** Canonical copy lives in [docs/lovable-prompts/LOVABLE-PROMPT-RISK-DIAGNOSIS-DC.md](../lovable-prompts/LOVABLE-PROMPT-RISK-DIAGNOSIS-DC.md). **Keep this file in sync** with that copy.

**Use when:** [implementation-guide-phase-4-dc.md](./implementation-guide-phase-4-dc.md) Step 4.2.
...
- [implementation-guide-phase-4-dc.md](./implementation-guide-phase-4-dc.md)
- [add-risk-diagnosis.sql](../database/migrations/add-risk-diagnosis.sql)
- [schema.md](../database/schema.md) §3.4c–3.4d
