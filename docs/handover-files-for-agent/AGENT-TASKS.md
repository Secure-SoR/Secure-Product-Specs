...
*Last sync: Backend has property_utility_applicability and property_service_charge_includes; for-agent and handover-files-for-agent updated with coverage/applicability. Data Library: Taxonomy v3, Energy/Waste component architecture, upload/edit/delete, sample CSVs. Next: Dashboards + KPI coverage, Agent Phase 5.*
